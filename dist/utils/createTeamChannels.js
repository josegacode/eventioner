...
const createTeamPrivateChannels = (params) => {
    ...
    const mentorRole = params.guild.roles.cache.find((guildRole) => guildRole.name == "Mentorx");
    const teamCategoryChannel = params.guild.channels.cache.find((guildChannel) => guildChannel.name
        .trim()
        .toLowerCase() === `equipos`);
...
//# sourceMappingURL=createTeamChannels.js.map